// Ion.Sound | version 3.0.1 | https://github.com/IonDen/ion.sound
(function(k,e,m,r){k.ion=k.ion||{};if(!ion.sound){var l=function(a){a||(a="undefined");if(k.console){console.warn&&"function"===typeof console.warn?console.warn(a):console.log&&"function"===typeof console.log&&console.log(a);var b=m("#debug");if(b.length){var c=b.html();b.html(c+a+"<br/>")}}},f=function(a,b){var c;b=b||{};for(c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b};if("function"!==typeof Audio&&"object"!==typeof Audio)e=function(){l("HTML5 Audio is not supported in this browser")},ion.sound=
...
clear:function(){this.paused_time=this.played_time=this.start_time=0},setVolume:function(a){this.volume=a.volume;this.sound&&(this.sound.volume=this.volume)}})}}})(window,navigator,jQuery||$);
